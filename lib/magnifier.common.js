...
// CONCATENATED MODULE: ./src/components/ImageMagnifier.vue?vue&type=template&id=b72d9658&
...
/* harmony default export */ var ImageMagnifiervue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    calcZoomSize: function calcZoomSize() {
      var _this2 = this;

      this.$nextTick(function () {
        _this2.imgRect = _this2.$refs.img && _this2.$refs.img.getBoundingClientRect();
        _this2.maskRect = _this2.$refs.mask && _this2.$refs.mask.getBoundingClientRect(); //计算大图宽高

        _this2.zoomImgWidth = _this2.imgRect.width / _this2.maskRect.width * _this2.zoomWidth;
        _this2.zoomImgHeight = _this2.imgRect.height / _this2.maskRect.height * _this2.zoomHeight;
      });
    },
...
/******/ });
//# sourceMappingURL=magnifier.common.js.map