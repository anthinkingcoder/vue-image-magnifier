...
// CONCATENATED MODULE: ./src/components/ImageMagnifier.vue?vue&type=template&id=0a47d5b8&
  ...
  methods: {
    handleOver: function handleOver() {
      ...
      if (this.delayIn === 0) {
        ...
        this.zoomInTimeoutId = setTimeout(function () {
          _this.zoomShow = true;
        }, this.delayIn);
      }
    },
    calcZoomSize: function calcZoomSize() {
      ...
      this.maskRect = this.$refs.mask && this.$refs.mask.getBoundingClientRect(); //计算大图宽高
    ...
    handleOut: function handleOut() {
      ...
      if (this.delayOut === 0) {
        ...
        this.zoomOutTimeoutId = setTimeout(function () {
          _this2.zoomShow = false;
        }, this.delayOut);
      }
    },
